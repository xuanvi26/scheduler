...
storiesOf("InterviewerListItem", module)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Show", () => (
      <Show student="Lydia Miller-Jones" interviewer={interviewers[0]} onEdit={action("onEdit")} onDelete={action("onDelete")}/>
    ))
    .add("Confirm", () => (
    ...
    .add("Edit", () => (
      <Form name="Baboo" interviewers={interviewers} interviewer={1} onSave={action("onSave")} onCancel={action("onCancel")}/>
    ))
